...
type vis struct {
	filter    func(*PageRequest) error
	visit     func(*Page)
	linkFound func(*url.URL)
}

func (v *vis) Filter(p *PageRequest) error { return v.filter(p) }
func (v *vis) Visit(p *Page)               { v.visit(p) }
func (v *vis) LinkFound(u *url.URL)        { v.linkFound(u) }
func newvis() *vis {
	return &vis{
		filter:    func(p *PageRequest) error { return nil },
		visit:     func(p *Page) {},
...
func TestCrawler(t *testing.T) {
	...
	v.filter = func(p *PageRequest) error { return nil }
